...
public class ClientHandler {
	public static final ModelLayerLocation AXOLOTL = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("axolotl"), "head");
	public static final ModelLayerLocation BAT = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("bat"), "head");
	public static final ModelLayerLocation BEE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("bee"), "head");
	public static final ModelLayerLocation BLAZE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("blaze"), "head");
	public static final ModelLayerLocation CAT = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("cat"), "head");
	public static final ModelLayerLocation CAVE_SPIDER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("cave_spider"), "head");
	public static final ModelLayerLocation CHICKEN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("chicken"), "head");
	public static final ModelLayerLocation COD = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("cod"), "head");
	public static final ModelLayerLocation COW = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("cow"), "head");
	public static final ModelLayerLocation DOLPHIN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("dolphin"), "head");
	public static final ModelLayerLocation DONKEY = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("donkey"), "head");
	public static final ModelLayerLocation DROWNED = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("drowned"), "head");
	public static final ModelLayerLocation ENDERMAN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("enderman"), "head");
	public static final ModelLayerLocation ENDERMITE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("endermite"), "head");
	public static final ModelLayerLocation EVOKER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("evoker"), "head");
	public static final ModelLayerLocation FOX = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("fox"), "head");
	public static final ModelLayerLocation GHAST = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("ghast"), "head");
	public static final ModelLayerLocation GLOW_SQUID = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("glow_squid"), "head");
	public static final ModelLayerLocation GOAT = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("goat"), "head");
	public static final ModelLayerLocation HOGLIN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("hoglin"), "head");
	public static final ModelLayerLocation HORSE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("horse"), "head");
	public static final ModelLayerLocation HUSK = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("husk"), "head");
	public static final ModelLayerLocation ILLUSIONER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("illusioner"), "head");
	public static final ModelLayerLocation IRON_GOLEM = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("iron_golem"), "head");
	public static final ModelLayerLocation MAGMA_CUBE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("magma_cube"), "head");
	public static final ModelLayerLocation MULE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("mule"), "head");
	public static final ModelLayerLocation MOOSHROOM_BROWN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("brown_mooshroom"), "head");
	public static final ModelLayerLocation MOOSHROOM_RED = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("red_mooshroom"), "head");
	public static final ModelLayerLocation OCELOT = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("ocelot"), "head");
	public static final ModelLayerLocation PIG = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("pig"), "head");
	public static final ModelLayerLocation PIGLIN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("piglin"), "head");
	public static final ModelLayerLocation PIGLIN_BRUTE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("piglin_brute"), "head");
	public static final ModelLayerLocation PILLAGER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("pillager"), "head");
	public static final ModelLayerLocation SALMON = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("salmon"), "head");
	public static final ModelLayerLocation SHEEP = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("sheep"), "head");
	public static final ModelLayerLocation SHEEP_FUR = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("sheep_fur"), "head");
	public static final ModelLayerLocation SILVERFISH = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("silverfish"), "head");
	public static final ModelLayerLocation SLIME = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("slime"), "head");
	public static final ModelLayerLocation SNOW_GOLEM = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("snow_golem"), "head");
	public static final ModelLayerLocation SPIDER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("spider"), "head");
	public static final ModelLayerLocation SQUID = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("squid"), "head");
	public static final ModelLayerLocation STRAY = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("stray"), "head");
	public static final ModelLayerLocation TURTLE = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("turtle"), "head");
	public static final ModelLayerLocation VILLAGER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("villager"), "head");
	public static final ModelLayerLocation VINDICATOR = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("vindicator"), "head");
	public static final ModelLayerLocation WANDERING_TRADER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("wandering_trader"), "head");
	public static final ModelLayerLocation WITCH = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("witch"), "head");
	public static final ModelLayerLocation WOLF = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("wolf"), "head");
	public static final ModelLayerLocation ZOGLIN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("zoglin"), "head");
	public static final ModelLayerLocation ZOMBIE_VILLAGER = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("zombie_villager"), "head");
	public static final ModelLayerLocation ZOMBIFIED_PIGLIN = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("zombified_piglin"), "skull");
