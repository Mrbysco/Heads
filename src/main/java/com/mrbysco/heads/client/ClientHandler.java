...
public class ClientHandler {
	...
	static void registerSkullModel(EntityRenderersEvent.CreateSkullModels event) {
		event.registerSkullModel(HeadTypes.ALLAY, (entityModelSet) -> new BatSkullModel(entityModelSet.bakeLayer(ClientHandler.ALLAY)), Identifier.withDefaultNamespace("textures/entity/allay/allay.png"));
		event.registerSkullModel(HeadTypes.AXOLOTL_BLUE, (entityModelSet) -> new BatSkullModel(entityModelSet.bakeLayer(ClientHandler.AXOLOTL)), Identifier.withDefaultNamespace("textures/entity/axolotl/axolotl_blue.png"));
		event.registerSkullModel(HeadTypes.AXOLOTL_CYAN, (entityModelSet) -> new BatSkullModel(entityModelSet.bakeLayer(ClientHandler.AXOLOTL)), Identifier.withDefaultNamespace("textures/entity/axolotl/axolotl_cyan.png"));
		...
		event.registerSkullModel(HeadTypes.HOGLIN, (entityModelSet) -> new HoglinSkullModel(entityModelSet.bakeLayer(ClientHandler.HOGLIN)), Identifier.withDefaultNamespace("textures/entity/hoglin/hoglin.png"));
		event.registerSkullModel(HeadTypes.HORSE_BLACK, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_black.png"));
		event.registerSkullModel(HeadTypes.HORSE_BROWN, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_brown.png"));
		event.registerSkullModel(HeadTypes.HORSE_CHESTNUT, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_chestnut.png"));
		event.registerSkullModel(HeadTypes.HORSE_CREAMY, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_creamy.png"));
		event.registerSkullModel(HeadTypes.HORSE_DARKBROWN, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_darkbrown.png"));
		event.registerSkullModel(HeadTypes.HORSE_GRAY, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_gray.png"));
		event.registerSkullModel(HeadTypes.HORSE_SKELETON, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_skeleton.png"));
		event.registerSkullModel(HeadTypes.HORSE_UNDEAD, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_zombie.png"));
		event.registerSkullModel(HeadTypes.HORSE_WHITE, (entityModelSet) -> new HorseSkullModel(entityModelSet.bakeLayer(ClientHandler.HORSE)), Identifier.withDefaultNamespace("textures/entity/horse/horse_white.png"));
		event.registerSkullModel(HeadTypes.HUSK, (entityModelSet) -> new SkullModel(entityModelSet.bakeLayer(ClientHandler.HUSK)), Identifier.withDefaultNamespace("textures/entity/zombie/husk.png"));
		event.registerSkullModel(HeadTypes.ILLUSIONER, (entityModelSet) -> new IllagerSkullModel(entityModelSet.bakeLayer(ClientHandler.ILLUSIONER)), Identifier.withDefaultNamespace("textures/entity/illager/illusioner.png"));
		...
		event.registerSkullModel(HeadTypes.SHEEP_BLACK, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_BLUE, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_BROWN, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_CYAN, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_GRAY, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_GREEN, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_LIGHT_BLUE, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_LIGHT_GRAY, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_LIME, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_MAGENTA, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_ORANGE, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_PINK, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_PURPLE, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		event.registerSkullModel(HeadTypes.SHEEP_RED, (entityModelSet) -> new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP)), Identifier.withDefaultNamespace("textures/entity/sheep/sheep.png"));
		...
		event.registerSkullModel(HeadTypes.ZOMBIFIED_PIGLIN, (entityModelSet) -> new PiglinSkullModel(entityModelSet.bakeLayer(ClientHandler.ZOMBIFIED_PIGLIN)), Identifier.withDefaultNamespace("textures/entity/piglin/zombified_piglin.png"));
	}
}
