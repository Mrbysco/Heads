...
public class ClientHandler {
	...
	static void registerSkullModel(EntityRenderersEvent.CreateSkullModels event) {
		...
		event.registerSkullModel(HeadTypes.BLACK_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.BLACK)));
		event.registerSkullModel(HeadTypes.BLAZE, new SkullModel(entityModelSet.bakeLayer(ClientHandler.BLAZE)));
		event.registerSkullModel(HeadTypes.BLUE_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.BLUE)));
		event.registerSkullModel(HeadTypes.BROWN_MOOSHROOM, new MooshroomSkullModel(entityModelSet.bakeLayer(ClientHandler.BROWN_MOOSHROOM), false));
		event.registerSkullModel(HeadTypes.BROWN_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.BROWN)));
		...
		event.registerSkullModel(HeadTypes.CYAN_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.CYAN)));
		...
		event.registerSkullModel(HeadTypes.GRAY_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.GRAY)));
		event.registerSkullModel(HeadTypes.GREEN_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.GREEN)));
		...
		event.registerSkullModel(HeadTypes.LIGHT_BLUE_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.LIGHT_BLUE)));
		event.registerSkullModel(HeadTypes.LIGHT_GRAY_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.LIGHT_GRAY)));
		event.registerSkullModel(HeadTypes.LIME_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.LIME)));
		event.registerSkullModel(HeadTypes.MAGENTA_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.MAGENTA)));
		...
		event.registerSkullModel(HeadTypes.ORANGE_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.ORANGE)));
		...
		event.registerSkullModel(HeadTypes.PINK_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.PINK)));
		event.registerSkullModel(HeadTypes.PURPLE_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.PURPLE)));
		event.registerSkullModel(HeadTypes.RED_MOOSHROOM, new MooshroomSkullModel(entityModelSet.bakeLayer(ClientHandler.RED_MOOSHROOM), true));
		event.registerSkullModel(HeadTypes.RED_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.RED)));
		event.registerSkullModel(HeadTypes.SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.WHITE)));
		...
		event.registerSkullModel(HeadTypes.YELLOW_SHEEP, new SheepSkullModel(entityModelSet.bakeLayer(ClientHandler.SHEEP), new SheepSkullFurModel(entityModelSet.bakeLayer(ClientHandler.SHEEP_FUR), DyeColor.YELLOW)));
