...
public class IllagerSkullModel extends HeadModelBase {

	public IllagerSkullModel(ModelPart root) {
		super(root);
	}

	public static MeshDefinition createIllagerHead() {
	...
	public static LayerDefinition createIllagerSkullModel() {
		MeshDefinition meshdefinition = createIllagerHead();
