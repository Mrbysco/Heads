...
public class VillagerSkullModel extends HeadModelBase {

	public VillagerSkullModel(ModelPart root) {
		super(root);
	}

	public static MeshDefinition createVillagerHead() {
	...
	public static LayerDefinition createVillagerSkullModel() {
		MeshDefinition meshdefinition = createVillagerHead();
