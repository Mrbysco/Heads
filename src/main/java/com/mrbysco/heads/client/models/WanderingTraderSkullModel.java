...
public class WanderingTraderSkullModel extends HeadModelBase {

	public WanderingTraderSkullModel(ModelPart root) {
		super(root);
	}

	public static MeshDefinition createWitchHead() {
		MeshDefinition meshdefinition = VillagerSkullModel.createVillagerHead();
	...
	public static LayerDefinition createSkullModel() {
		MeshDefinition meshdefinition = createWitchHead();
