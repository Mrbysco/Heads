...
public class HeadLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		this.addHead(HeadsRegistry.SHEEP_BLACK, "Sheep", " Head (Black)");
		this.addHead(HeadsRegistry.SHEEP_BLUE, "Sheep", " Head (Blue)");
		this.addHead(HeadsRegistry.SHEEP_BROWN, "Sheep", " Head (Brown)");
		this.addHead(HeadsRegistry.SHEEP_CYAN, "Sheep", " Head (Cyan)");
		this.addHead(HeadsRegistry.SHEEP_GRAY, "Sheep", " Head (Gray)");
		this.addHead(HeadsRegistry.SHEEP_GREEN, "Sheep", " Head (Green)");
		this.addHead(HeadsRegistry.SHEEP_LIGHT_BLUE, "Sheep", " Head (Light Blue)");
		this.addHead(HeadsRegistry.SHEEP_LIGHT_GRAY, "Sheep", " Head (Light Gray)");
		this.addHead(HeadsRegistry.SHEEP_LIME, "Sheep", " Head (Lime)");
		this.addHead(HeadsRegistry.SHEEP_MAGENTA, "Sheep", " Head (Magenta)");
		this.addHead(HeadsRegistry.SHEEP_ORANGE, "Sheep", " Head (Orange)");
		this.addHead(HeadsRegistry.SHEEP_PINK, "Sheep", " Head (Pink)");
		this.addHead(HeadsRegistry.SHEEP_PURPLE, "Sheep", " Head (Purple)");
		this.addHead(HeadsRegistry.SHEEP_RED, "Sheep", " Head (Red)");
		this.addHead(HeadsRegistry.SHEEP_SHAVEN, "Shaven Sheep", " Head (Shaven)");
		this.addHead(HeadsRegistry.SHEEP_WHITE, "Sheep", " Head (White)");
		this.addHead(HeadsRegistry.SHEEP_YELLOW, "Sheep", " Head (Yellow)");
